      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8 z-10">
        {label && (
          <motion.div
            ...
            className="mb-4 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-1 text-xs font-mono font-bold text-blue-700 shadow-xs"
          >
        ...
        <motion.nav
          ...
          className="mt-8 flex items-center justify-center gap-1.5 text-xs font-mono text-slate-500"
        >
