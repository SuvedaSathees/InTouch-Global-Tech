...
export function ServiceDetail({ service }: { service: Service }) {
  return (
    <div className="relative">
      ...
      <section className="py-20 sm:py-28 relative overflow-hidden bg-white select-none">
          ...
          <div className="grid gap-12 lg:grid-cols-12 items-start">
            ...
            <div className="lg:col-span-8">
              <div className="rounded-2xl border border-slate-200 bg-white p-8 sm:p-10 shadow-sm">
                ...
                <div className="mt-10 rounded-xl border border-blue-200 bg-blue-50/60 p-6">
                  ...
                  <p className="mt-2 text-xs text-blue-800 leading-relaxed font-normal">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6 text-center">
                <p className="text-xs font-mono text-slate-500 font-medium">Average Delivery Timeline</p>
                <p className="text-2xl font-extrabold text-blue-600 font-mono mt-1">4 – 8 Weeks</p>
