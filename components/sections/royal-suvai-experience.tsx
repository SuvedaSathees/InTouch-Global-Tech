...
export function RoyalSuvaiDetailExperience({ project }: { project: Project }) {
  const currentIndex = projects.findIndex(
    (p) => p.slug === project.slug || p.slug === 'royal-suvai-restaurant-website' || p.slug === 'royal-suvai'
  );
  ...
  const deliverables = [
    {
      ...
      description: 'A responsive and visually engaging website designed to establish Royal Suvai\'s professional online presence.',
      icon: Globe,
    },
    {
      title: 'Menu & Food Showcase',
      description: 'An attractive presentation of the restaurant\'s food offerings, making it easier for customers to explore available choices.',
      icon: MenuSquare,
    },
    {
      title: 'User-Friendly Experience',
      description: 'Clear navigation and structured content help visitors find important restaurant information quickly.',
      icon: UtensilsCrossed,
    },
    {
      title: 'Mobile-Responsive Design',
      description: 'A seamless browsing experience across mobile, tablet and desktop devices.',
      icon: Smartphone,
    },
    {
      title: 'Restaurant Branding',
      description: 'A digital experience designed to reflect the restaurant\'s identity while creating an appealing first impression for visitors.',
      icon: Star,
    },
    {
      title: 'SEO Optimization',
      description: 'We optimized the website\'s structure, content and search visibility to help Royal Suvai reach potential customers searching for relevant restaurant and food services online.',
      icon: Search,
    }
  ];
    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 select-none">
      ...
      <header className="pt-32 pb-14 sm:pt-40 sm:pb-18 border-b border-slate-200/80 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-[1084px] px-4 sm:px-6 lg:px-8 space-y-8 text-left relative z-10">
          ...
          <div className="space-y-3">
            ...
            >
              Royal Suvai is a restaurant serving customers through a diverse food offering. We created a professional digital presence that helps customers discover the restaurant, explore its offerings and connect with the business online.
            </motion.p>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-white border-y border-slate-200/80">
        <div className="mx-auto max-w-[1084px] px-4 sm:px-6 lg:px-8 space-y-8 text-left">
          ...
          <div className="space-y-4 text-base sm:text-lg text-slate-700 leading-relaxed font-normal">
            <p>
              Kumar approached us with the requirement for a professional website for Royal Suvai that could represent the restaurant online and provide customers with an easy way to discover its offerings.
            </p>
            <p>
              The website needed to present the restaurant in a clear, attractive and user-friendly format, while also creating a stronger presence in search engines.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-[#F8FAFC]">
        <div className="mx-auto max-w-[1084px] px-4 sm:px-6 lg:px-8 space-y-12 text-left">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-base sm:text-lg text-slate-700 leading-relaxed font-normal">
              <p>
                We designed and developed a modern, responsive restaurant website focused on presenting Royal Suvai's brand and food offerings through an engaging digital experience.
              </p>
              <p>
                The website was structured to make important information easy to discover, while providing customers with a simple journey from discovering the restaurant to exploring its offerings and getting in touch.
              </p>
              <p>
                Alongside the website development, we implemented SEO optimization to improve the website's structure, content and search visibility, helping Royal Suvai become more discoverable to potential customers online.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 bg-[#F8FAFC]">
        <div className="mx-auto max-w-[1084px] px-4 sm:px-6 lg:px-8 space-y-8 text-left">
          ...
          <div className="space-y-4 text-base sm:text-lg text-slate-700 leading-relaxed font-normal">
            <p>
              The new website gave Royal Suvai a stronger and more professional digital presence, allowing customers to discover the restaurant and explore its offerings more easily.
            </p>
            <p>
              Through responsive design, structured content and SEO optimization, we created a digital platform that not only represents the restaurant visually but also improves its ability to be discovered through search engines.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-10 relative z-10">
          <div className="space-y-4 max-w-3xl mx-auto">
            ...
            <p className="text-sm sm:text-base text-slate-300 leading-relaxed font-normal">
              A modern, responsive and SEO-optimized restaurant website that strengthens Royal Suvai's online presence and creates a clear digital journey for customers to discover the restaurant, explore its offerings and connect with the business.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-2">
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md space-y-1">
              <span className="text-cyan-400 text-lg">💬</span>
              <p className="text-xs sm:text-sm font-bold text-white leading-tight">
                Created for better connections.
              </p>
            </div>
          </div>
          ...
          <div className="pt-4 flex flex-wrap items-center justify-center gap-4">
            {project.liveUrl && (
              ...
              >
                <span>Explore Royal Suvai Live</span>
      ...
      <footer className="border-t border-slate-200 bg-white py-8">
        <div className="mx-auto max-w-[1084px] px-4 sm:px-6 lg:px-8 flex flex-wrap items-center justify-between gap-3 sm:gap-4">
          <Link
