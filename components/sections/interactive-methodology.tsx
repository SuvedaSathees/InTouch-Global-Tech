      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 z-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 relative z-10">
            {stages.map((stage) => {
              ...
              return (
                ...
                >
                  <div
                    className={`flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-2xl font-semibold font-bold text-sm sm:text-base transition-all shadow-xs mb-3 ${
                      isActive
                  ...
                  <span
                    className={`text-[11px] font-semibold font-bold uppercase tracking-wider mb-0.5 ${
                      isActive ? 'text-blue-700' : 'text-slate-600'
                    }`}
                  >
                    {stage.number} • {stage.phase}
                  </span>
                  <span className="text-[10px] font-semibold text-slate-500 font-medium">
                    {stage.timeframe}
                  </span>
                </motion.button>
              );
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="lg:col-span-5 space-y-5 text-left">
              <div className="inline-flex items-center gap-2 rounded-full bg-blue-50 border border-blue-200 px-3.5 py-1 text-xs font-semibold text-blue-700 font-bold">
              ...
              <div className="rounded-2xl border border-blue-200 bg-white p-4 shadow-xs">
                <span className="text-[10px] font-semibold uppercase tracking-widest text-blue-700 font-bold block mb-1">
                  Guaranteed Milestone Deliverable:
                </span>
                <div className="flex items-center gap-2 text-sm font-bold text-slate-900 font-semibold">
            ...
            <div className="lg:col-span-7">
              <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm relative overflow-hidden">
                ...
                <div className="space-y-3 py-2 text-xs font-semibold text-slate-700">
        ...
        <div className="mt-20 sm:mt-28 rounded-3xl border border-slate-200 bg-slate-50/80 p-8 sm:p-14 shadow-xs relative overflow-hidden text-center">
          <div className="relative z-10 max-w-3xl mx-auto mb-12">
            <span className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3.5 py-1 text-xs font-semibold font-bold text-blue-700 mb-4">
        ...
        {/* 3 ELEGANT TRUST BADGES */}
        <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <div className="flex items-start gap-4 p-5 rounded-2xl border border-slate-200 bg-white shadow-xs">
            ...
            <div>
              <h4 className="text-sm font-bold text-slate-950">NDA Protected</h4>
              <p className="text-xs text-slate-600 mt-1 leading-relaxed font-normal">
                Project specifications and proprietary algorithms remain strictly confidential.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 p-5 rounded-2xl border border-slate-200 bg-white shadow-xs">
            ...
            <div>
              <h4 className="text-sm font-bold text-slate-950">24-Hour Response</h4>
              <p className="text-xs text-slate-600 mt-1 leading-relaxed font-normal">
                Fast communication, direct sprint feedback, and rapid technical resolution.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 p-5 rounded-2xl border border-slate-200 bg-white shadow-xs">
            ...
            <div>
              <h4 className="text-sm font-bold text-slate-950">Direct Architect Chat</h4>
              <p className="text-xs text-slate-600 mt-1 leading-relaxed font-normal">
                Direct communication with senior system architects. No intermediary layers.
              </p>
            </div>
          </div>
        </div>
