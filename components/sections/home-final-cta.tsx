  ...
  return (
    <section className="relative overflow-hidden bg-white text-slate-900 py-24 sm:py-32 select-none border-t border-slate-200">
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 z-10">
        <div className="rounded-3xl bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 p-5 min-[380px]:p-8 sm:p-16 text-center text-white shadow-2xl shadow-blue-500/25 relative overflow-hidden">
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="mt-12 pt-8 border-t border-blue-400/40 flex flex-wrap items-center justify-center gap-3.5 sm:gap-10 text-xs text-blue-100 font-medium">
