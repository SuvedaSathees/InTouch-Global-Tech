...
export function MagnertiaErpDetailExperience({ project }: { project: Project }) {
  const currentIndex = projects.findIndex(
    (p) => p.slug === project.slug || p.slug === 'magnertia-erp-system' || p.slug === 'erp-system'
  );
  ...
  const deliverables = [
    {
      title: 'HR Management',
      description: 'A centralized system to manage employee-related information and HR operations.',
      icon: Users,
    },
    {
      title: 'CMS Management',
      description: 'A structured content management system allowing administrators to manage and update required digital content.',
      icon: FileText,
    },
    {
      title: 'Administration Management',
      description: 'Centralized administrative controls for managing day-to-day business operations and system activities.',
      icon: Settings,
    },
    {
      title: 'ERP Dashboard',
      description: 'A unified dashboard providing a clear view of important information and management activities.',
      icon: LayoutDashboard,
    },
    {
      title: 'Centralized Data Management',
      description: 'Business and employee information organized within one accessible platform.',
      icon: Database,
    },
    {
      title: 'Role-Based Administration',
      description: 'Structured access and management controls for different administrative requirements.',
      icon: ShieldCheck,
    },
    {
      title: 'Custom ERP Development',
      description: 'The entire system was developed based on the client\'s original idea, workflow and business requirements.',
      icon: Code2,
    }
  ];
    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 select-none">
          ...
          <div className="space-y-3">
            ...
            >
              <span className="text-xs sm:text-sm font-mono font-bold uppercase tracking-wider text-blue-600">
                Integrated HR, CMS & Administration Platform
              </span>
            ...
            >
              The goal was to move everyday administrative and HR-related activities into one digital platform instead of managing them across separate processes.
            </motion.p>
          </div>
      ...
      <section className="py-12 sm:py-16 bg-[#F8FAFC]">
        <div className="mx-auto max-w-[1084px] px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl border border-slate-200 bg-white p-3 sm:p-4 shadow-xl overflow-hidden group">
            ...
            <div
              onClick={() => setLightboxImage({ src: '/images/magnertia-erp/hero.jpg', caption: 'Hero Image — Business & ERP Dashboard' })}
            ...
            >
              <Image 
                src="/images/magnertia-erp/hero.jpg" 
                alt="Business ERP System" 
                fill 
            ...
            <div className="pt-3 px-2 flex items-center justify-between text-xs text-slate-500">
              <span className="font-semibold text-slate-700">Hero Image — Business & ERP Dashboard</span>
              <span className="text-[11px] font-mono">Centralized Management</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-white border-y border-slate-200/80">
        <div className="mx-auto max-w-[1084px] px-4 sm:px-6 lg:px-8 space-y-8 text-left">
          ...
          <div className="space-y-4 text-base sm:text-lg text-slate-700 leading-relaxed font-normal">
            <p>
              The client approached us with an idea to bring their business operations into a centralized ERP system. As this was their first experience using an ERP, they needed a solution that was structured, practical and easy to manage.
            </p>
            <p>
              The goal was to move everyday administrative and HR-related activities into one digital platform instead of managing them across separate processes.
            </p>
      ...
      <section className="py-16 sm:py-20 bg-[#F8FAFC]">
        <div className="mx-auto max-w-[1084px] px-4 sm:px-6 lg:px-8 space-y-12 text-left">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-base sm:text-lg text-slate-700 leading-relaxed font-normal">
              <p>
                We transformed the client's idea into a custom ERP management platform combining HR Management, CMS Management and Administration within a single system.
              </p>
              <p>
                The platform was designed around the client's workflow, providing a centralized environment to manage important business operations efficiently and access information from one place.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-3 sm:p-4 shadow-lg overflow-hidden group">
            <div
              onClick={() => setLightboxImage({ src: '/images/magnertia-erp/dashboard.png', caption: 'Project Image — ERP Management Interface' })}
            ...
            >
              <Image 
                src="/images/magnertia-erp/dashboard.png" 
                alt="ERP Management Interface" 
                fill 
                className="object-cover transition-transform duration-500 group-hover:scale-105" 
              />
              <div className="absolute inset-0 bg-slate-950/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center text-white backdrop-blur-[2px]">
            ...
            <div className="pt-3 px-2 flex items-center justify-between text-xs text-slate-500">
              <span className="font-semibold text-slate-700">Project Image — ERP Management Interface</span>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-[#F8FAFC]">
        <div className="mx-auto max-w-[1084px] px-4 sm:px-6 lg:px-8 space-y-8 text-left">
          ...
          <div className="space-y-4 text-base sm:text-lg text-slate-700 leading-relaxed font-normal">
            <p>
              The ERP brought the client's HR, CMS and administrative activities into one centralized digital platform.
            </p>
            <p>
              Instead of relying on disconnected processes, the client can now manage key operations through a structured ERP system designed specifically for their needs.
            </p>
            <p>
              As this was their first ERP implementation, the platform was built with a focus on usability, clarity and practical day-to-day management.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-10 relative z-10">
          <div className="space-y-4 max-w-3xl mx-auto">
            ...
            <p className="text-sm sm:text-base text-slate-300 leading-relaxed font-normal">
              The client's idea was transformed into a functional ERP platform that brings HR, CMS and administration together in one system.
            </p>
            <p className="text-sm sm:text-base text-slate-300 leading-relaxed font-normal">
              The client was very satisfied with the final solution, particularly with how the platform converted their idea into a practical digital management system.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-2">
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md space-y-1">
              ...
              <p className="text-xs sm:text-sm font-bold text-white leading-tight">
                From an idea to an ERP platform.
              </p>
            </div>
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md space-y-1">
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md space-y-1">
              <span className="text-cyan-400 text-lg">📈</span>
              <p className="text-xs sm:text-sm font-bold text-white leading-tight">
                Designed for easier management.
              </p>
            </div>
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md space-y-1">
              <span className="text-cyan-400 text-lg">⚡</span>
              <p className="text-xs sm:text-sm font-bold text-white leading-tight">
                Created for smarter business operations.
              </p>
            </div>
          </div>
          ...
          <div className="pt-4 flex flex-wrap items-center justify-center gap-4">
            {project.liveUrl && (
              ...
              >
                <span>Explore Magnertia ERP Live</span>
